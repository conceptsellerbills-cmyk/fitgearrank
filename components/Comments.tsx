  ...
  return (
    <>
      <style>{`
        ...
        .comments-heading{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#ef4444;margin-bottom:6px}
        ...
        .comment-avatar{width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#ef444455,#ef444422);display:flex;align-items:center;justify-content:center;font-size:0.85rem;font-weight:700;color:#ef4444;flex-shrink:0}
        ...
        .comment-name-input:focus,.comment-body-input:focus{border-color:#ef4444}
        ...
        .comment-submit{background:#ef4444;color:#fff;border:none;border-radius:8px;padding:11px 28px;font-size:0.9rem;font-weight:700;cursor:pointer;transition:opacity 0.15s}
