  ...
  return (
    <>
      <style>{`
        ...
        .c-reply-btn:hover{color:#ef4444}
        ...
        .comment-submit{background:#ef4444;color:#fff;border:none;border-radius:8px;padding:10px 24px;font-size:0.9rem;font-weight:700;cursor:pointer;transition:opacity 0.15s}
