...
export function Comments({ title }: CommentsProps) {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-repo", "conceptsellerbills-cmyk/fitgearrank");
    script.setAttribute("data-repo-id", "R_kgDOR8_5ww");
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOR8_5w84C6gbM");
