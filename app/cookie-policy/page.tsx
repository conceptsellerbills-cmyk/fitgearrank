...
export const metadata: Metadata = { title: "Cookie Policy — FitGearRank", description: "Cookie Policy for FitGearRank (fitgearrank.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@fitgearrank.com">hello@fitgearrank.com</a>.</p>
      </div>
    </>
  );
}
