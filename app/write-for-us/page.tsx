...
export const metadata: Metadata = { title: "Write for Us — FitGearRank", description: "Contribute a guest post to FitGearRank. Share your expertise on fitness and wellness products." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know fitness and wellness products well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on fitness and wellness products</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@fitgearrank.com">hello@fitgearrank.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
