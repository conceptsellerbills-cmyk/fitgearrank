...
export const metadata: Metadata = { title: "Terms of Use — FitGearRank", description: "Terms of Use for FitGearRank (fitgearrank.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>By accessing and using fitgearrank.com, you accept and agree to be bound by these Terms of Use. If you do not agree with any part of these terms, please do not use our website.</p>
        <h2>2. Use of Content</h2>
        <p>All content published on FitGearRank — including articles, reviews, images, and graphics — is the intellectual property of FitGearRank unless otherwise stated. You may not reproduce, distribute, or republish our content without prior written permission.</p>
        ...
        <p>FitGearRank is not liable for any direct, indirect, or consequential damages arising from your use of this website or reliance on information published here.</p>
        ...
        <h2>7. Contact</h2>
        <p>For questions about these Terms of Use, contact us at <a href="mailto:hello@fitgearrank.com">hello@fitgearrank.com</a>.</p>
      </div>
    </>
  );
}
