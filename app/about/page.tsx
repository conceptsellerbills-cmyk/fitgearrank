...
export const metadata: Metadata = { title: "About — FitGearRank", description: "Learn about FitGearRank, our mission, and the team behind the site." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">About FitGearRank</h1>
        <p className="page-subtitle">We're a team of passionate writers and researchers dedicated to covering fitness and wellness products — helping our readers make smarter decisions with honest, in-depth content.</p>
        <hr className="page-divider" />
        <h2>Our Mission</h2>
        <p>FitGearRank was created with a single goal: to cut through the noise and give readers clear, trustworthy information about fitness and wellness products. We research, test, and compare so you don't have to.</p>
        <h2>What We Cover</h2>
        <p>We publish in-depth reviews, comparison guides, how-tos, and roundups on fitness and wellness products. Every article is written with accuracy and reader value in mind — no filler, no fluff.</p>
