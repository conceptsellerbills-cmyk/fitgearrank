...
const CATEGORIES: { label: string; href: string }[] = [{"label":"🏋️ Dumbbells & Weights","href":"/category/dumbbells"},{"label":"🚴 Cardio Equipment","href":"/category/cardio"},{"label":"🧘 Yoga & Pilates","href":"/category/yoga-pilates"},{"label":"🏃 Running Gear","href":"/category/running"},{"label":"💪 Resistance Bands","href":"/category/resistance-bands"},{"label":"🥊 Boxing & MMA","href":"/category/boxing"},{"label":"🏊 Swimming Gear","href":"/category/swimming"},{"label":"⌚ Fitness Trackers","href":"/category/fitness-trackers"},{"label":"🧴 Supplements","href":"/category/supplements"},{"label":"👟 Athletic Footwear","href":"/category/athletic-shoes"},{"label":"🏠 Home Gym Setup","href":"/category/home-gym"},{"label":"🔄 Recovery & Mobility","href":"/category/recovery"}];
...
export default async function ArticlePage({ params }: Props) {
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.fitgearrank.com" },
      ...(post.category ? [{ "@type": "ListItem", position: 2, name: post.category.replace(/-/g, " ").replace(/\b\w/g, (l: string) => l.toUpperCase()), item: `https://www.fitgearrank.com/category/${post.category}` }] : []),
      { "@type": "ListItem", position: post.category ? 3 : 2, name: post.title, item: `https://www.fitgearrank.com/${slug}` },
    ],
  });
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--bg:#0a0808;--surface:#111520;--border:#1e2535;--text:#e4e8f4;--muted:#7a82a0;--accent:#ef4444;--radius:10px}
        ...
        .article-body a:hover{color:#f87171}
          ...
          <article className="article">
            ...
            <div className="author-box">
              ...
              <div className="author-info">
                <div className="author-name">Fit Gear Rank Editorial Team</div>
