...
export const metadata: Metadata = { title: "Contact — FitGearRank", description: "Get in touch with the FitGearRank team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@fitgearrank.com">hello@fitgearrank.com</a>. We reply within 1–2 business days.</p>
        </div>
