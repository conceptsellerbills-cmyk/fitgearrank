...
export default function NotFound() {
  ...
  return (
    <>
      <style>{`
        .nf-wrap{min-height:70vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 24px;text-align:center;background:#130404}
        .nf-code{font-size:clamp(5rem,15vw,9rem);font-weight:900;line-height:1;background:linear-gradient(135deg,#ef444455,#ef4444);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-bottom:8px}
        ...
        .nf-btn-primary{background:#ef4444;color:#fff;border:none;padding:12px 28px;border-radius:8px;font-size:0.95rem;font-weight:700;cursor:pointer;text-decoration:none;transition:opacity 0.15s}
        ...
        .nf-btn-secondary:hover{border-color:#ef4444;color:#ef4444}
        ...
        .nf-card:hover{border-color:#ef4444;transform:translateY(-2px)}
