...
export const metadata: Metadata = { title: "Advertise — FitGearRank", description: "Advertise with FitGearRank and reach a targeted audience interested in fitness and wellness products." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on FitGearRank</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing fitness and wellness products. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@fitgearrank.com">hello@fitgearrank.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
