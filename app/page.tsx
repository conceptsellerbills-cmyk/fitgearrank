...
export const metadata: Metadata = {
  ...
  description: "Expert-tested rankings of home gym equipment, fitness wearables, running gear and supplements. Find the gear that actually performs.",
};
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          ...
          --accent: #ef4444; --accent2: #f97316; --radius: 12px;
        }
        body { background: var(--bg); color: var(--text); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; line-height: 1.6; }
        a { text-decoration: none; color: inherit; }
        .container { max-width: 1100px; margin: 0 auto; padding: 0 24px; }
        .hero { position: relative; overflow: hidden; padding: 90px 24px 80px; text-align: center; }
        .hero::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(239,68,68,0.15) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(249,115,22,0.1) 0%, transparent 60%); pointer-events: none; }
        .hero-badge { display: inline-flex; align-items: center; gap: 8px; padding: 6px 16px; border-radius: 20px; background: rgba(239,68,68,0.1); border: 1px solid rgba(239,68,68,0.25); color: var(--accent); font-size: 0.8rem; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 24px; }
        ...
        .hero-cta { display: inline-flex; align-items: center; gap: 8px; padding: 14px 32px; border-radius: 50px; background: linear-gradient(135deg, var(--accent), var(--accent2)); color: #fff; font-weight: 700; font-size: 1rem; transition: opacity 0.2s, transform 0.2s; box-shadow: 0 0 30px rgba(239,68,68,0.3); }
        ...
        .category-card:hover { border-color: var(--accent); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(239,68,68,0.1); }
        ...
        .featured-visual { display: flex; align-items: center; justify-content: center; min-height: 280px; font-size: 5rem; background: linear-gradient(135deg, rgba(239,68,68,0.12), rgba(249,115,22,0.08)); }
        .featured-content { padding: 40px 36px; display: flex; flex-direction: column; justify-content: center; gap: 0; }
        .featured-badge { display: inline-block; padding: 4px 12px; border-radius: 20px; background: rgba(239,68,68,0.12); border: 1px solid rgba(239,68,68,0.25); color: var(--accent); font-size: 0.72rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 16px; width: fit-content; }
        ...
        .cta-section { margin: 20px 0 60px; padding: 60px 40px; background: linear-gradient(135deg, var(--surface), rgba(239,68,68,0.06)); border: 1px solid var(--border); border-radius: var(--radius); text-align: center; }
...
`}</style>
      ...
      <section className="hero">
        ...
        <h1 dangerouslySetInnerHTML={{ __html: "Fitness Gear That<br />Actually Delivers Results" }} />
        <p>Rigorous testing and honest rankings of gym equipment, wearables, running shoes and nutrition products. Stop wasting money. Train smarter.</p>
        <a href="/top-fitness-gear" className="hero-cta">View Top Rankings →</a>
        <div className="stats-bar">
          {([{"v":"400+","l":"Products Tested"},{"v":"30+","l":"Expert Reviewers"},{"v":"100K+","l":"Monthly Readers"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((s) => (
      ...
      <div className="container">
        ...
        <div className="cta-section">
          ...
          <p>Expert-tested fitness gear rankings so you buy with confidence and train without regret.</p>
