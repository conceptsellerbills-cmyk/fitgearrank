    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-bg { position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(239,68,68,0.18) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(249,115,22,0.12) 0%, transparent 60%); pointer-events: none; }
      ...
      <section className="hero">
        ...
        <div className="hero-badge">Performance Tested</div>
        <h1 dangerouslySetInnerHTML={{ __html: "Fitness Gear That<br />Actually Delivers" }} />
        <p>Rigorous real-world testing and honest rankings of gym equipment, wearables, running shoes and nutrition products. Train smarter, spend less.</p>
        <div className="hero-ctas">
          <a href="/top-fitness-gear" className="hero-cta-primary">View Top Rankings →</a>
          <a href="/categories" className="hero-cta-secondary">Browse Categories →</a>
        </div>
        <div className="stats-bar">
          {([{"v":"400+","l":"Products Tested"},{"v":"30+","l":"Expert Testers"},{"v":"100K+","l":"Monthly Readers"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((st) => (
      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingBottom: 40 }}>
          ...
          <div className="trending-row">
            {([{"label":"Best Home Gym 2025","hot":true,"href":"/best-home-gym-equipment"},{"label":"Apple Watch vs Garmin","hot":true,"href":"/apple-watch-vs-garmin"},{"label":"Best Running Shoes","href":"/best-running-shoes"},{"label":"Creatine vs Pre-Workout","hot":true,"href":"/creatine-vs-preworkout"},{"label":"Peloton Alternatives","href":"/peloton-alternatives"},{"label":"Best Protein Powder","href":"/best-protein-powder"}] as {label:string,hot?:boolean,href:string}[]).map((t) => (
        ...
        <section className="section" style={{ paddingTop: 20 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Top Fitness Picks of 2025</h2>
          </div>
          <div className="picks-grid">
            {([{"badge":"Best Tracker","badgeType":"gold","icon":"⌚","title":"Garmin Forerunner 265","desc":"Best-in-class GPS accuracy, 13-day battery life and the most accurate health metrics available.","rating":5,"href":"/garmin-forerunner-265-review"},{"badge":"Best Home Gym","badgeType":"silver","icon":"🏋️","title":"REP Fitness PR-4000","desc":"Commercial-grade power rack at a fraction of the gym cost. Built to last 20+ years.","rating":5,"href":"/rep-pr-4000-review"},{"badge":"Best Running Shoe","badgeType":"bronze","icon":"👟","title":"HOKA Clifton 9","desc":"Maximum cushioning with a surprisingly lightweight feel — ideal for daily training runs.","rating":4,"href":"/hoka-clifton-9-review"}] as {badge:string,badgeType:string,icon:string,title:string,desc:string,rating:number,href:string}[]).map((p, i) => (
        ...
        <section className="section">
          ...
          <div className="section-header">
            <h2 className="section-title">How We Test Fitness Gear</h2>
          </div>
          <div className="how-grid">
            {([{"num":"01","title":"We Train with It","desc":"Every product is used for a minimum of 4 weeks of real training before we form any judgment."},{"num":"02","title":"We Measure Performance","desc":"Wearables are compared against medical-grade devices. Gear is stress-tested to verify durability claims."},{"num":"03","title":"You Train with Confidence","desc":"Buy once, buy right. Our rankings save you from expensive mistakes and returns."}] as {num:string,title:string,desc:string}[]).map((h) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"🏋️","label":"Home Gym","desc":"Dumbbells, benches & racks","href":"/category/home-gym"},{"icon":"⌚","label":"Wearables","desc":"Fitness trackers & smartwatches","href":"/category/wearables"},{"icon":"👟","label":"Running Gear","desc":"Shoes, GPS watches & apparel","href":"/category/running"},{"icon":"🧘","label":"Yoga & Pilates","desc":"Mats, blocks & equipment","href":"/category/yoga"},{"icon":"🥗","label":"Nutrition","desc":"Protein, supplements & bars","href":"/category/nutrition"},{"icon":"🚴","label":"Cardio","desc":"Bikes, treadmills & rowers","href":"/category/cardio"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
          ...
          <section className="section" style={{ paddingTop: 0 }}>
            ...
            <a href={`/${featured.slug}`} className="featured-card">
              ...
              <div className="featured-content">
                <span className="featured-badge">🏆 Best in Class</span>
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Why Readers Trust FitGear Rank</h2>
          </div>
          <div className="why-grid">
            {([{"icon":"🏋️","title":"Real Athletes Test","desc":"Our reviewers are certified personal trainers, competitive runners and serious fitness enthusiasts."},{"icon":"📏","title":"We Measure Everything","desc":"Heart rate accuracy, VO2 max precision, material durability — we quantify what others guess at."},{"icon":"⏱️","title":"4-Week Minimum","desc":"No first impressions passed off as reviews. Minimum 4 weeks of real training per product."},{"icon":"💸","title":"Every Budget Covered","desc":"From budget picks under $50 to premium gear worth the splurge — we rank across all price points."}] as {icon:string,title:string,desc:string}[]).map((w) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="faq-list">
            {([{"q":"What is the best fitness tracker in 2025?","a":"Garmin Forerunner 265 for serious athletes, Apple Watch Series 9 for Apple ecosystem users, and Fitbit Charge 6 for budget-conscious buyers."},{"q":"Is a home gym worth it vs a gym membership?","a":"If you train consistently, a home gym typically pays for itself within 12-18 months compared to a gym membership. We have a detailed cost breakdown guide."},{"q":"What protein powder do you recommend?","a":"Optimum Nutrition Gold Standard for whey protein, and Momentous Essential Plant Protein for the best vegan option. Both have clean ingredient lists and are third-party tested."},{"q":"How do you test running shoes?","a":"Our testers log a minimum of 60 miles in each shoe across different surfaces and paces before reviewing. We measure weight, stack height and cushioning response."},{"q":"What is the best budget home gym setup?","a":"A set of adjustable dumbbells ($150-200), a pull-up bar ($30), and resistance bands ($25) gives you a complete workout for under $300. We have a full guide."}] as {q:string,a:string}[]).map((f) => (
        ...
        <div className="newsletter-section">
          ...
          <p>Get weekly gear rankings, training tips and the best fitness deals straight to your inbox.</p>
          <NewsletterForm />
        </div>

        {/* ── CTA ── */}
        <div className="cta-section">
          <h2>Stop Guessing, Start Gaining</h2>
          <p>Expert-tested fitness gear rankings so you buy with total confidence and never waste money on disappointment.</p>
          <a href="/top-fitness-gear" className="cta-btn">Browse All Rankings →</a>
        </div>
