...
export const metadata: Metadata = {
  title: "All Articles — FitGearRank",
  description: "Browse every article published on FitGearRank.",
};
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .aa-eyebrow{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#ef4444;margin-bottom:8px}
        ...
        .aa-card{background:#120f0f;border:1px solid #1e2535;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;transition:border-color 0.15s,transform 0.15s}
        .aa-card:hover{border-color:#ef4444;transform:translateY(-2px)}
        ...
        .aa-tag{display:inline-block;font-size:0.68rem;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;color:#ef4444;background:#ef444418;border:1px solid #ef444430;padding:3px 10px;border-radius:20px;margin-bottom:12px;width:fit-content}
        .aa-card-title{font-size:0.98rem;font-weight:700;line-height:1.4;margin-bottom:8px;color:#e4e8f4}
        .aa-card-title:hover{color:#ef4444}
        ...
        .aa-read{font-size:0.82rem;font-weight:600;color:#ef4444}
