...
export const metadata: Metadata = { title: "Affiliate Disclosure — FitGearRank", description: "Affiliate Disclosure for FitGearRank." };
export default function AffiliateDisclosurePage() {
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .page-eyebrow{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#ef4444;margin-bottom:10px}
  ...
  .form-group input:focus,.form-group textarea:focus,.form-group select:focus{border-color:#ef4444}
  .form-group input::placeholder,.form-group textarea::placeholder{color:#4b5563}
  .form-submit{background:#ef4444;color:#fff;border:none;border-radius:10px;padding:13px 32px;font-size:1rem;font-weight:700;cursor:pointer;align-self:flex-start;transition:opacity 0.15s}
  ...
  .highlight-box{background:rgba(239,68,68,0.08);border:1px solid rgba(239,68,68,0.25);border-radius:12px;padding:24px 28px;margin:28px 0}
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="highlight-box">
          <p><strong>FitGearRank participates in affiliate programs, including the Amazon Associates Program.</strong> This means we may earn a commission when you click on certain links and make a purchase — at no additional cost to you.</p>
        </div>
        <h2>How It Works</h2>
        ...
        <p>FitGearRank is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com.</p>
        <h2>Other Affiliate Programs</h2>
        <p>We may also participate in affiliate programs with other retailers and brands relevant to fitness and wellness products. All affiliate relationships are disclosed with "sponsored" or "affiliate link" labels where applicable.</p>
        <h2>Questions?</h2>
        <p>If you have questions about our affiliate relationships, contact us at <a href="mailto:hello@fitgearrank.com">hello@fitgearrank.com</a>.</p>
      </div>
    </>
  );
}
