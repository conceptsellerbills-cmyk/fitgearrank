...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/",
    types: {
      "application/rss+xml": [{ url: "/feed.xml", title: "Fit Gear Rank RSS Feed" }],
    },
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebSite","name":"Fit Gear Rank","url":"https://www.fitgearrank.com","potentialAction":{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.fitgearrank.com/all-articles?q={search_term_string}"},"query-input":"required name=search_term_string"}}` }} />
        <style>{`
          ...
          .footer-nl-form input:focus{border-color:#ef4444}
          .footer-nl-form button{background:#ef4444;color:#fff;border:none;border-radius:8px;padding:10px 20px;font-size:0.85rem;font-weight:700;cursor:pointer;white-space:nowrap;transition:opacity 0.15s}
        ...
        <header className="site-header">
          <div className="header-inner">
            <a href="/" className="site-brand">
              <svg className="site-logo" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="footer-inner">
            <div className="footer-grid">
              ...
              <div className="footer-col1">
                ...
                <p className="footer-desc">Expert reviews of fitness equipment, workout gear, skincare, and wellness products to help you train smarter and live healthier.</p>
            ...
            <div className="footer-bottom">
              <p className="footer-copy">© {new Date().getFullYear()} FitGearRank. All rights reserved.</p>
            </div>
          </div>
        </footer>
